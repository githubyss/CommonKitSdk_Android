...
object ComkitLogcatUtils {
    ...
    val LOG_TOP_BORDER =
        "${LOG_LEFT_TOP_CORNER}${LOG_HORIZONTAL_DOUBLE_LINE}${LOG_HORIZONTAL_DOUBLE_LINE}"
    val LOG_BOTTOM_BORDER =
        "${LOG_LEFT_BOTTOM_CORNER}${LOG_HORIZONTAL_DOUBLE_LINE}${LOG_HORIZONTAL_DOUBLE_LINE}"
    val LOG_MIDDLE_BORDER =
        "${LOG_LEFT_MIDDLE_CORNER}${LOG_HORIZONTAL_SINGLE_LINE}${LOG_HORIZONTAL_SINGLE_LINE}"
    ...
    private fun printJson(element: StackTraceElement, jsonString: String) {
        ...
        try {
            ...
            for (line in lines) {
                stringBuilder.append("$LOG_VERTICAL_DOUBLE_LINE ").append(line)
    ...
    private fun printObjectString(
        ...
        if (!string.isEmpty()) {
            ...
            stringBuilder.append(LOG_TOP_BORDER).append(SYSTEM_LINE_SEPARATOR)
                .append(LOG_VERTICAL_DOUBLE_LINE).append(" ").append(tag)
                .append(SYSTEM_LINE_SEPARATOR)
    ...
    private fun printObjectCollectionOneLine(
        tag: String,
        fileName: String,
        simpleName: String,
    ...
    private fun printObjectCollection(
        tag: String,
        fileName: String,
        simpleName: String,
        collection: Collection<*>
