package com.githubyss.common.kit.manager.audio_player.player
...
import com.githubyss.common.kit.constant.IntentActionConstants
...
class AudioPlayService : Service() {
    ...
    private fun initLocalBroadcastReceiver() {
        ...
        intentFilter.addAction(IntentActionConstants.INTENT_ACTION_CLOSE_FLOAT)
    ...
    private class MyBroadcastReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            else if (action == IntentActionConstants.INTENT_ACTION_CLOSE_FLOAT) {
