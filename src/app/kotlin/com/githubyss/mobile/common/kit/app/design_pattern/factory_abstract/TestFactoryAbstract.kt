...
import com.githubyss.mobile.common.kit.design_pattern.factory_abstract.*
...
fun factoryAbstract() {
    ...
    val shipFactoryKClass: FactoryAbstractKClass<IShip> = FactoryConcreteKClass<IShip>()
    val shipWar: IShip? = shipFactoryKClass.create<ShipWar>(ShipWar::class)
    shipWar?.let {
        shipWar.weighAnchor()
        shipWar.dropAnchor()
